...
public class HttpRequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    public HttpRequestHandler(String defaultUrl) {
...
//        ctx.writeAndFlush(response).addListener(ChannelFutureListener.CLOSE);
        ...
        // 设置头信息
        response.headers().set(HttpHeaderNames.CONTENT_TYPE, "text/html; charset=UTF-8").set("test", "just for test");
...
//        demo1(ctx, req);
    ...
    private void demo1(ChannelHandlerContext ctx, FullHttpRequest req) {
        //100 Continue

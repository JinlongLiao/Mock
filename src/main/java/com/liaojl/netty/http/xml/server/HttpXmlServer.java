...
public class HttpXmlServer {
    private static final Logger log = LoggerFactory.getLogger(HttpXmlServer.class);
    ...
    public void run(final int port) throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
                    ...
                    .childHandler(new ChannelInitializer() {
                        ...
                        protected void initChannel(Channel ch)
                            ...
                            ch.pipeline().addLast("http-server-coder", new HttpServerCodec());
            ...
            log.info("HTTP订购服务器启动，网址是 : " + "http://localhost:"
                    + port);

package com.liaojl.test.ssl.server;
...
public class SSLServer {
    ...
    public void init() {
        try {
            ...
            ks.load(new FileInputStream("src/main/resources/ssl/kserver.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());
            tks.load(new FileInputStream("src/main/resources/ssl/tserver.keystore"), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());
